...
@section('title', 'Mobile Banking Accounts')
@push('head')
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >List of Mobile Banking Accounts </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-title-actions float-right">
                    <a title="Create Button" href="{{ route('mobile-banking-account.create') }}" type="button" class="btn btn-sm btn-success">
...
<script>
    ...
    var dTable = $('#data_table').DataTable({
        ...
        ajax: {
            url: "{{route('mobile-banking-account.index')}}",
            type: "get"
        },
    ...
    $('.card-body').on('click', '.changeStatus', function (e) {
        ...
        if (changeStatus) {
            $.ajax({
                'url':"{{ route('mobile-banking-account.status') }}",
                'type':'get',
                'dataType':'json',
                'data':{id:id},
