...
@section('title', 'Create Mobile Banking Account')
@section('content')
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >Create Mobile Banking Account </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" action="{{ route('mobile-banking-account.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="owner_info_id">Account Holder Name<span class="text-red">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mobile_no" name="mobile_no" value="{{ old('mobile_no') }}"class="form-control @error('mobile_no') is-invalid @enderror" placeholder="Enter mobile no" required>
