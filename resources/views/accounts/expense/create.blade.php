                        ...
                        <form enctype="multipart/form-data" action="{{ route('expense.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date" name="date" value="{{ old('date') }}"class="form-control @error('date') is-invalid @enderror" placeholder="Enter month" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <input type="number" id="amount" onkeyup="Amount(1)" name="amount[]" value="{{ old('amount') }} "class="form-control amount @error('amount') is-invalid @enderror" placeholder="Enter expense amount" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="account_id" id="account_id"  class="form-control @error('account_id ') is-invalid @enderror">
                                        ...
                                        @foreach ($banks as $key => $bank)
                                         @if($bank->owner_info_id == Auth::user()->owners->id)
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mobile_banking_id" id="mobile_banking_id"  class="form-control @error('mobile_banking_id') is-invalid @enderror">
                                        ...
                                        @foreach ($mobilebanks as $key => $mobilebank)
                                            @if($mobilebank->owner_info_id == Auth::user()->owners->id)
