            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >List of Expense Categories </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                @can('manage_user')
                    <div class="page-title-actions float-right">
                        <a title="Create Button" href="{{ route('expense-category.create') }}" type="button" class="btn btn-sm btn-success">
...
<script>
    ...
    $('.card-body').on('click', '.changeStatus', function (e) {
        ...
        if (changeStatus) {
            $.ajax({
                'url':"{{ route('expense-category.status') }}",
                'type':'get',
                'dataType':'json',
                'data':{id:id},
