            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >List of Bank Accounts </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-title-actions float-right">
                    <a title="Create Button" href="{{ route('bank-account.create') }}" type="button" class="btn btn-sm btn-success">
