            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >Edit Bank Account </h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" action="{{ route('bank-account.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date" name="date" value="{{ $data->date }}"class="form-control @error('date') is-invalid @enderror" placeholder="Enter date" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="account_no" name="account_no" value="{{ $data->account_no }}"class="form-control @error('account_no') is-invalid @enderror" placeholder="Enter account no" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="branch_name" name="branch_name" value="{{ $data->branch_name }}"class="form-control @error('branch_name') is-invalid @enderror" placeholder="Enter branch name" required>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="branch_address" class="form-control" rows="2" placeholder="Write branch address">{{ $data->branch_address }}</textarea>
