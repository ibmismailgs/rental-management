...
@section('title', 'Monthly Rent Collect')
@push('head')
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10"> Month : <span class="text-primary"> {{Carbon\carbon::parse( $month)->format('F, Y') }}</span></h5>
                    </div>
                </div>
            </div>
        </div>
