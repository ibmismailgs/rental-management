            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >Tenant Details</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-title-actions float-right">
                    ...
                    <a title="Create Button" href="{{ route('tenant-info.create') }}" type="button" class="btn btn-sm btn-success">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach($cardNames as $cardName)
                                    <span>
                                        ...
                                        @elseif($cardName == 3) Birtd Certificate,
                            ...
                            <tr>
                                ...
                                @foreach($cardPhotos as $cardPhoto)
                                    <span> <img height="50px" widtd="100px" src="{{ asset('img/'.$cardPhoto )}}" alt="ID Card Photo">,
                                    </span>
                                @endforeach
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>Tenant Photo</td>
                                <td><img height="50px" widtd="100px" src="{{asset('img/'.$data->tenant_photo)}}" alt="Tenant Photo">
                                </td>
                            </tr>
                        </tbody>
