    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" action="{{ route('rent-info.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="tenant_photo" id="tenant_photo" data-height="100" class="dropify form-control @error('tenant_photo') is-invalid @enderror">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="flat_size" name="flat_size" class="form-control" readonly>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rent_title" name="rent_title" value="{{ old('rent_title') }}" class="form-control @error('address') is-invalid @enderror" readonly>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="bedroom" name="bedroom"  class="form-control bed " readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="bathroom" name="bathroom"  class="form-control bed" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="master_bedroom" name="master_bedroom" class="form-control bed" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="guest_bedroom" name="guest_bedroom" class="form-control bed" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="balcony" name="balcony" class="form-control" readonly>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <div class="form-group">
                                          <p id="daining_space" ><label for="daining_space">Dining Space </label> <b>:</b>

                                            <br><span for="yes" style="display: none" class="ml-10 badge badge-success" title="Dainig Space" id="yes">Yes</span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="total_room" class="form-control "  readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="flat_rent" name="flat_rent" value="{{ old('flat_rent') }}"class="form-control rent @error('rent') is-invalid @enderror" placeholder="Enter flat rent" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="gas_bill" name="gas_bill" value="{{ old('gas_bill') }}"class="form-control rent @error('gas_bill') is-invalid @enderror" placeholder="Enter gas bill" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="water_bill" name="water_bill" value="{{ old('water_bill') }}"class="form-control rent @error('water_bill') is-invalid @enderror" placeholder="Enter water bill" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="service_charge" name="service_charge" value="{{ old('service_charge') }}"class="form-control rent @error('service_charge') is-invalid @enderror" placeholder="Enter service charge" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="total_rent" name="total_rent" value="{{ old('total_rent') }}"class="form-control" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        @if ($user_role->name == 'Super Admin')
                                            <select name="tenant_info_id" id="tenant_info_id"  class="form-control tenant @error('tenant_info_id') is-invalid @enderror" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="father_name" id="father_name" placeholder="Enter father name" class="form-control @error('father_name') is-invalid @enderror" >
                                ...
                                <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-3">
                                    ...
                                    <label for="thana">Thana<span class="text-red">*</span></label>
                                      <input type="text" name="thana" class="form-control" id="thana" placeholder="Enter thana" required>
                                  </div>
                                  </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="holding">Holding<span class="text-red">*</span></label>
                                                <input type="text" name="holding" class="form-control" id="holding" placeholder="Enter holding" required>
                                          </div>
                                         @error('holding')
                                        <span class="text-danger" role="alert">
                                            <p>{{ $message }}</p>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="road" class="form-control" id="road" placeholder="Enter road">
                                         @error('road')
                                        <span class="text-danger" role="alert">
                                            <p>{{ $message }}</p>
                                        </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tenantMobile" name="tenant_mobile" value="{{ old('tenant_mobile') }}"class="form-control @error('mobile') is-invalid @enderror" readonly>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}"class="form-control @error('email') is-invalid @enderror" readonly>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="tenantNid" name="tenant_nid"  class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="passport" name="passport"  class="form-control" placeholder="Enter passport">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="qualification" name="qualification" class="form-control" placeholder="Enter eduactional qualification">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="profession" name="profession" value="{{ old('profession') }}" placeholder="Enter profession" class="form-control @error('address') is-invalid @enderror" >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="professional_address" class="form-control" rows="3" placeholder="Write professional address">{{ old('professional_address') }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="permanent_address" id="permanent_address" class="form-control" rows="3" readonly>{{ old('permanent_address') }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="emergency_name" class="form-control" id="emergency_name" placeholder="Enter name" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="relation" name="relation" class="form-control" placeholder="Enter relation" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="emergency_mobile" name="emergency_mobile" class="form-control" placeholder="Enter mobile no" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="emergency_address" class="form-control" rows="1" placeholder="Write your address">{{ old('emergency_address') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sn" name="sn[]" value="{{ 1 }}" class="form-control @error('sn') is-invalid @enderror" readonly>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="member_name" name="member_name[]" value="{{ old('member_name') }}" class="form-control @error('member_name') is-invalid @enderror" placeholder="Enter name" >
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="member_age" name="member_age[]" value="{{ old('member_age') }}" class="form-control @error('member_age') is-invalid @enderror" placeholder="Enter age" >
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="member_profession" name="member_profession[]" value="{{ old('member_profession') }}" class="form-control @error('member_profession') is-invalid @enderror" placeholder="Enter profession">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input type="text" name="member_mobile[]" id="member_mobile" class="form-control @error('member_mobile') is-invalid @enderror" placeholder="Enter mobile no">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                     <label for="maid_name">Maid Name</label>
                                         <input type="text" name="made_name" class="form-control" id="made_name" placeholder="Enter maid name">
                                   </div>

                             <div class="col-sm-4">
                                 <div class="form-group">
                                     <label for="made_nid">Maid NID</label>
                                     <input type="number" id="made_nid" name="made_nid" class="form-control" placeholder="Enter made nid">
                                 </div>
                             </div>

                             <div class="col-sm-4">
                                 <div class="form-group">
                                     <label for="made_mobile">Maid Mobile</label>
                                     <input type="text" id="made_mobile" name="made_mobile" class="form-control" placeholder="Enter maid mobile no">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-12">
                                 <div class="form-group">
                                     ...
                                     <textarea name="made_address" class="form-control" rows="1" placeholder="Write address">{{ old('made_address') }}</textarea>
                                 </div>
                             </div>
                         </div>
                            ...
                            <div class="row">
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     <input type="number" id="driver_nid" name="driver_nid" class="form-control" placeholder="Enter driver nid">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     <input type="text" id="driver_mobile" name="driver_mobile" class="form-control" placeholder="Enter driver mobile no">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-12">
                                 <div class="form-group">
                                     ...
                                     <textarea name="driver_address" class="form-control" rows="1" placeholder="Write address">{{ old('driver_address') }}</textarea>
                                 </div>
                             </div>
                         </div>
                            ...
                            <div class="col-sm-4">
                                 <div class="form-group">
                                     <label for="previous_owner_name">Owner Name</label>
                                         <input type="text" name="previous_owner_name" class="form-control" id="previous_owner_name" placeholder="Enter previous owner name">
                                     </div>
                             </div>
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     <input type="number" id="previous_owner_nid" name="previous_owner_nid" class="form-control" placeholder="Enter nid">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     <input type="text" id="previous_owner_mobile" name="previous_owner_mobile" class="form-control" placeholder="Ente mobile no">
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-6">
                                 <div class="form-group">
                                     ...
                                     <textarea name="previous_owner_address" class="form-control" rows="2" name="previous_owner_address" placeholder="Write address">{{ old('previous_owner_address') }}</textarea>
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-6">
                                 <div class="form-group">
                                     ...
                                     <textarea name="leave_reason" class="form-control" rows="2" placeholder="Write reason">{{ old('leave_reason') }}</textarea>
                                 </div>
                             </div>
                         </div>
                            ...
                            <div class="row">
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     <input type="email" id="present_owner_email" name="present_owner_nid" class="form-control" readonly>
                                 </div>
                             </div>
                             ...
                             <div class="col-sm-4">
                                 <div class="form-group">
                                     ...
                                     @if ($user_role->name == 'Super Admin')
                                        <input type="text" id="present_owner_mobile" name="present_owner_mobile" class="form-control" readonly>
                                        @else
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Dropify/0.2.2/js/dropify.min.js"
    ...
    <script>
            ...
            $("#AddField").append(`<div class="row" id="removed">
                <div class="col-sm-1">
                    <div class="form-group">
                        ...
                        <input type="text" id="sn" name="sn[]" value="${i}" class="form-control @error('sn') is-invalid @enderror" readonly>
        ...
        $("#flat_info").on('change', function(){
            var flat_id= $('#flat_info').val();
            var date = {{ date("Ymd")}};
            $.ajax({
                url: "{{ route('ownerwise-flat-tenant') }}",
                dataType: 'Json',
                ...
                success: function(data){
                    $('#rent_title').val(data.flatData.flat_name+-+date);
                    $('#flat_size').val(data.flatData.flat_size);
                    $('#bedroom').val(data.flatData.bedroom);
                    $('#master_bedroom').val(data.flatData.master_bedroom);
                    $('#guest_bedroom').val(data.flatData.guest_bedroom);
                    $('#bathroom').val(data.flatData.bathroom);
                    $('#balcony').val(data.flatData.balcony);
                    $('#daining_space').val(data.flatData.daining_space);
                    var dainingSpace = $('#daining_space').val(data.flatData.daining_space);
                    if(dainingSpace = 1){
                    $('#yes').show();
                    $('#no').hide();
                    }else {
